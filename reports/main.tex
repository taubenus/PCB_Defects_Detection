...
{\large Supervisor: Gaspard Grimm}\\[0.5ex]
{\large \href{mailto:gaspard@datascientest.com}{\textit{\textcolor{blue}{gaspard@datascientest.com}}}}\\[4ex]
...
%Validation accuracy for segmentation is above 93\% already after the first training (20 epochs with loss weights 80/20 seg/class) and reaching 97\% after the final training (20 epochs with loss weights inverted i.e. 20/80 seg/class). It is not before the 10th epoch that the validation accuracy for classification is reaching 70\%. Same holds for classification precision and recall.
...
\begin{thebibliography}{10} 
    \bibitem{wevolver_pcb_inspection}
    ...
    \bibitem{TensorFlowTransferLearning}
    ...
    \bibitem{TensorFlowImageDataGenerator}
