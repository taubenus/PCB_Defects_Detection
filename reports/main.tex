...
{\large \href{mailto:w.faiza@gmx.de}{\textit{\textcolor{blue}{w.faiza@gmx.de}}}}\\[3ex]
{\large Niels Hartanto}\\[0.5ex]
{\large \href{mailto:niels@gmx.de}{\textit{\textcolor{blue}{nylz-ds@proton.me}}}}\\[3ex]
{\large Gernot Gellwitz}\\[0.5ex]
{\large \href{mailto:gernot@gmx.de}{\textit{\textcolor{blue}{g-not@gmx.de}}}}\\[3ex]
...
\begin{figure}[h]
    ...
    %\includegraphics[width=0.8\textwidth]{./graphics/separated_img2.png}
